...
unblocks the dependent step but does not close the gate task bead itself (e.g. the
plan-approval gate bead in writing-plans — close it explicitly after resolving).
