...
- [reference/rationalizations.md](reference/rationalizations.md) — the common excuses that lead to skipping tests, merging without consent, or over-cleaning worktrees, and the reality that counters each.
- [reference/quick-reference.md](reference/quick-reference.md) — the option-by-option summary of merge, push, worktree, and branch-cleanup behavior.
